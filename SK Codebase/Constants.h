...
#define REUSE_IDENTIFIER__SYSTEM_MODE_CELL_STD @"SystemModeCellStd"
#define REUSE_IDENTIFIER__SYSTEM_MODE_CELL_STD_DIRTY @"SystemModeCellStdDirty"
...
#define REFRESH_INTERVAL__SYSTEM_MODE_CHANGE 5
...
#define ACTION_ID__CHANGE_SYSTEM_MODE 9004
...
#define ENTITY_TYPE__UNKWNOWN -1
...
#define NOTIFICATION_NAME__GRAPH_UPDATE_REQUESTED @"GraphUpdateRequested"
#define NOTIFICATION_NAME__GRAPH_DIRTIFICATION_UPDATING @"GraphDirtified"
#define NOTIFICATION_NAME__GRAPH_UPDATED @"GraphUpdated"
...
#define GRAPH_REQ_NOTIFICATION__ENTITY_REQ_DATA_KEY @"GraphData"
#define ALERT_INFO_NOTIFICATION__ALERT_MSG_KEY @"Msg"
#define GRAPH_UPDATE_NOTIFICATION__GRAPH_ENTITY_KEY @"GraphEntityId"
#define GRAPH_UPDATE_NOTIFICATION__GRAPH_DATA_KEY @"GraphDataKey"
